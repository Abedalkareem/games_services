...
class Leaderboards(private var activityPluginBinding: ActivityPluginBinding) :
  ...
  fun showLeaderboards(activity: Activity?, leaderboardID: String, span: Int, collection: Int, result: MethodChannel.Result) {
    ...
    if (leaderboardID.isEmpty()) {
      ...
      leaderboardsClient
        .getLeaderboardIntent(leaderboardID, span, collection)
        .addOnSuccessListener(onSuccessListener)
        .addOnFailureListener(onFailureListener)
    }
  }
