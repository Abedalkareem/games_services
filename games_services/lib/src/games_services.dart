...
class GamesServices {
  ...
  @Deprecated('Use [Achievements.loadAchievements]')
  ...
  @Deprecated('Use [Achievements.unlock]')
  ...
  @Deprecated('Use [Achievements.increment]')
  ...
  @Deprecated('Use [Leaderboards.showLeaderboards]')
  ...
  @Deprecated('Use [Leaderboards.loadLeaderboardScores]')
  ...
  /// [value] the score.
  @Deprecated('Use [Leaderboards.submitScore]')
  ...
  @Deprecated('Use [Player.getPlayerHiResImage]')
  ...
  @Deprecated('Use [Player.isUnderage]')
  ...
  @Deprecated('Use [Player.isMultiplayerGamingRestricted]')
  ...
  @Deprecated('Use [Player.isPersonalizedCommunicationRestricted]')
  ...
  @Deprecated('Use [Player.showAccessPoint]')
  ...
  @Deprecated('Use [Player.hideAccessPoint]')
  ...
  @Deprecated('Use [SaveGame.saveGame]')
